...
module mkDM_Abstract_Commands(CLK,
  ...
  wire [31 : 0] virt_rg_abstractcs__h500, virt_rg_command__h564;
  wire [15 : 0] regno__h1869;
  wire [12 : 0] x__h1051;
  ...
  always@(av_read_dm_addr or
	  rg_data0 or virt_rg_abstractcs__h500 or virt_rg_command__h564)
  begin
    case (av_read_dm_addr)
      7'h16: av_read = virt_rg_abstractcs__h500;
      7'h17: av_read = virt_rg_command__h564;
  ...
  FIFO1 #(.width(32'd45), .guarded(32'd1)) f_hart0_csr_reqs(.RST(RST_N),
							    .CLK(CLK),
  ...
  FIFO1 #(.width(32'd33), .guarded(32'd1)) f_hart0_csr_rsps(.RST(RST_N),
							    .CLK(CLK),
  ...
  FIFO1 #(.width(32'd38), .guarded(32'd1)) f_hart0_gpr_reqs(.RST(RST_N),
							    .CLK(CLK),
  ...
  FIFO1 #(.width(32'd33), .guarded(32'd1)) f_hart0_gpr_rsps(.RST(RST_N),
							    .CLK(CLK),
  ...
  assign MUX_f_hart0_gpr_reqs$enq_1__VAL_1 =
	     { 1'd1, x__h1051[4:0], rg_data0 } ;
  assign MUX_f_hart0_gpr_reqs$enq_1__VAL_2 =
	     { 1'd0, x__h1051[4:0], 32'hAAAAAAAA } ;
  ...
  // remaining internal signals
  assign regno__h1869 = { 3'd0, rg_command_access_reg_regno } ;
  ...
  assign virt_rg_abstractcs__h500 =
	     { 19'd0, rg_abstractcs_busy, 1'b0, rg_abstractcs_cmderr, 8'd1 } ;
  assign virt_rg_command__h564 =
	     { 15'd17, rg_command_access_reg_write, regno__h1869 } ;
  ...
  assign x__h1051 = rg_command_access_reg_regno - 13'h1000 ;
  ...
  begin
    ...
    v__h3271 = v__h3277 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 &&
	  rg_abstractcs_cmderr == 3'd0 &&
	  write_dm_addr != 7'h17 &&
	  write_dm_addr != 7'h04)
	$write("%0d: DM_Abstract_Commands.write: [", v__h3271);
    if (RST_N != `BSV_RESET_VALUE)
