...
module mkCore(CLK,
  ...
  begin
    ...
    v__h5021 = v__h5027 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_soc_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_soc_start", v__h5021);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h5222 = v__h5228 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_dm_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_dm_start", v__h5222);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h5590 = v__h5596 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_complete)
	$display("%0d: Core.rl_cpu_hart0_reset_complete", v__h5590);
  end
  // synopsys translate_on
endmodule  // mkCore
